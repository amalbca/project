    ...
    <div class="swiper vehicles-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                <img src="image\Swift-SZ4.jpg""" alt="">
                <div class="content">
                    <h3>swift</h3>
                    <div class="price"> <span>price : </span> 2000/-RS  </div>
                    <p>
                        new
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    <h3>SWIFT</h3>
                    <div class="price"> <span>price : </span> 2500/-RS </div>
                    <p>
                        new
                        <span class="fas fa-circle"></span> 2021
                        <span class="fas fa-circle"></span> automatic
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    <h3>swift</h3>
                    <div class="price"> <span>price : </span> 3000/-RS </div>
                    <p>
                        new
                        <span class="fas fa-circle"></span> 2021
                        <span class="fas fa-circle"></span> automatic
